...
<head lang="en">
    ...
    <link href="<%=ctxPath%>/css/login.css" rel="stylesheet" />
</head>
<body>
<!--模态框-->
<div class="modal">
...
<header id="top">
    <div class="top">
        <img src="<%=ctxPath%>/img/header/logo.png" alt=""/>
        <span>欢迎注册</span>
    </div>
</header>
<div class="parent">
    <div class="container">
        <div class="panel rt">
            <form id="fm-register" method="post" action="<%=ctxPath%>/register.do">
                <div class="txt">
                    <p id="newuser">新用户注册
                        <span>
              <a href="<%=ctxPath%>/login.do" id="dlogin">直接登录</a>
            </span>
                    </p>
                </div>
