...
<head lang="en">
    ...
    <link href="<%=ctxPath%>/css/pro.details.css" rel="stylesheet" />
...
<header id="top">
    <div id="logo" class="lf">
        <img class="animated jello" src="<%=ctxPath%>/img/header/logo.png" alt="logo"/>
    </div>
...
<div id="shop_detail">
    ...
    <div id="preview" class="lf">
        <div id="mediumDiv">
            <img id="mImg" src="${book.detailBigImg}"/>
        </div>
        <div id="icon_all">
            <ul id="icon_list">
                <li class="i1"><img src="${book.detailImg}" /></li>
                <%--<li class="i1"><img src="<%=ctxPath%>/img/goods/9787115435101/detail2.jpg" onerror="this.style.display='none'" /></li>
                <li class="i1"><img src="<%=ctxPath%>/img/goods/9787115435101/detail3.jpg" onerror="this.style.display='none'" /></li>
                <li class="i1"><img src="<%=ctxPath%>/img/goods/9787115435101/detail4.jpg" onerror="this.style.display='none'" /></li>
                <li class="li"><img src="<%=ctxPath%>/img/goods/9787115435101/detail5.jpg" onerror="this.style.display='none'" /></li>--%>
            </ul>
        </div>
    </div>
    <!-- 右侧-->
    <div class="right_detail lf">
        ...
        <p class="parameter">
            <b>客服：</b>
            <span class="connect">联系客服</span><img class="gif" src="<%=ctxPath%>/img/product_detail/kefuf.gif">
        </p>
        <!-- 出版社 -->
        ...
        <p>
            <s>出版日期：</s>
            <span><fmt:formatDate value="${book.published}" pattern="yyyy - MM - dd"/></span>
        </p>
        <!-- 未选择规格，颜色时状态-->
        ...
        <div class="shops">
            ...
            <a href="#" class="shop lf" id="add_cart"><img src="<%=ctxPath%>/img/product_detail/product_detail_img7.png" alt=""/>加入购物车</a>
            <a href="#" class="collection lf" id="collect"><span>收藏</span></a><b><img src='<%=ctxPath%>/img/product_detail/product_detail_img62.png' alt=""/></b>
        </div>
    </div>
</div>
<!--为你推荐-->
            ...
            <div id="demo1" style="float:left"><!-- 第一个宽度显示 -->
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="detail.html?isbn=9787302435167"><img src="<%=ctxPath%>/img/recommend/recommend_img1.jpg" border="0"></a>
                    </div>
                    <p>大数据架构师指南</p>
                </div>
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="detail.html?isbn=9787115335500"><img src="<%=ctxPath%>/img/recommend/recommend_img2.jpg" border="0"></a>
                    </div>
                    <p>深入浅出Node.js</p>
                </div>
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="detail.html?isbn=9787111213826"><img src="<%=ctxPath%>/img/recommend/recommend_img3.jpg" border="0"></a>
                    </div>
                    <p>Java编程思想</p>
                </div>
                <div class="detail_1 lf">
                    <div class="detail_img1">
                        <a href="detail.html?isbn=9787111545682"><img src="<%=ctxPath%>/img/recommend/recommend_img4.jpg" border="0"></a>
                    </div>
                    <p>Linux运维最佳实践</p>
                </div>
                <!--</div>-->
...
<div id="iteminfo">
    <div id="tab">
        ...
        <div class="cart rt">
            <img src="<%=ctxPath%>/img/product_detail/product_detail_img9.png" alt=""/>
        </div>
    </div>
    <div class="left lf">
        <div class="all">
            ...
            <div id="parm">
                <div id="specification_parameter">
                    <p>
                        规格参数
                        <img src="<%=ctxPath%>/img/product_detail/product_detail_icon_1.png" alt="" class="ys5"/>
                    </p>
            ...
            <div id="product_introduction">
                <p>
                    商品介绍
                    <img src="<%=ctxPath%>/img/product_detail/product_detail_icon_4.png" alt="" class="ys5"/>
                </p>
                <img src="${book.introImg}" alt=""/>
            </div>
            <div id="sale_protection">
                <p>
                    售后保障
                    <img src="<%=ctxPath%>/img/product_detail/product_detail_icon_3.png" alt="" class="ys5"/>
                </p>

                <div class="sale_content">
                    <p class="paper" id="sale_protect">
                        <img src="<%=ctxPath%>/img/product_detail/product_detail_img16.png" alt=""/>
                        正品保障
                    </p>
    ...
    <div class="right rt">
        <div class="aside_nav">
            <p><i><img src="<%=ctxPath%>/img/product_detail/product_detail_icon_g_1.png" alt=""/></i><a href="#specification_parameter">规格参数</a></p>
            <p><i><img src="<%=ctxPath%>/img/product_detail/product_detail_icon_t_1.png" alt=""/></i><a href="#product_introduction">商品介绍</a></p>
            <p><i><img src="<%=ctxPath%>/img/product_detail/product_detail_icon_d_1.png" alt=""/></i><a href="#sale_protection">售后保障</a></p>
            <p><i><img src="<%=ctxPath%>/img/product_detail/product_detail_icon_up_1.png" alt=""/></i><a href="#">回到顶部</a></p>
        </div>
    </div>
</div>
<!-- 品质保障，私人定制等-->
...
<script>
    $('#icon_list>li').click(function(){
        ...
        var bigaddress=${book.detailBigImg};
