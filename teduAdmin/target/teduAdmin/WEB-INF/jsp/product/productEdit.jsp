    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" role="form" action="<%=ctxPath%>/Product/productEdit.do" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 my-input">
                                <input type="text" class="form-control" name="published" id="published" value="<fmt:formatDate value="${book.published}" pattern="yyyy-MM-dd"/>" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="format" class="col-sm-2 control-label my-label">开本</label>
                            <div class="col-sm-10 my-input">
                                <input type="text" class="form-control" name="format" id="format" value="${book.format}" readonly>
                            </div>
                            <label for="packaging" class="col-sm-2 control-label my-label">包装</label>
                            <div class="col-sm-10 my-input">
                                <input type="text" class="form-control" name="packaging" id="packaging" value="${book.packaging}" readonly>
                            </div>
                            <label for="form" class="col-sm-2 control-label my-label">用纸</label>
                            <div class="col-sm-10 my-input">
                                <input type="text" class="form-control" name="form" id="form" value="${book.form}" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-4 my-img">
                                <img class="img-responsive" src="${book.indexImg}" alt="Detail 1 Photo is missing">
                            </div>
                            <div class="col-sm-4 my-img">
                                <img class="img-responsive" src="${book.indexImg}" alt="Detail 2 Photo is missing">
                            </div>
                            <div class="col-sm-4 my-img">
                                <img class="img-responsive" src="${book.indexImg}" alt="Detail 3 Photo is missing">
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
...
<script>
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            // alert("*"+data+"*");
            if(data=='yes'){
                window.location.href="<%=ctxPath%>/page/product-detail.html";
            }
        }
    });
</script>
