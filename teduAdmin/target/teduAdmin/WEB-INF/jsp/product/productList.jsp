                    ...
                    <table id="my_order" class="table table-bordered table-striped">
                        ...
                        <c:forEach items="${bookList}" var="book">
                            <tr>
                                <td>${book.isbn}</td>
                                <td>${book.title}</td>
                                <td><fmt:formatDate value="${book.published}" pattern="yyyy-MM-dd"></fmt:formatDate></td>
                                <td><span class="label bg-yellow">￥${book.price}</span></td>
                                <td><a href="<%=ctxPath%>/Product/productDetail.do?id=${book.id}">查看</a>丨<a href="<%=ctxPath%>/Product/productEdit.do?id=${book.id}">编辑</a></td>
                            </tr>
                        </c:forEach>
...
<script>
    $(function () {
     ...
     'processing': true,
     'serverSide': true,
     'ajax': '<%=ctxPath%>/servlet/all-product',
     'columns': [
    	    { 'data': 'isbn' },
    	    { 'data': 'title' },
    	    ...
    	    { 'data': null , 'render': function (data, type, row, meta) { 
    	    		return '<a href="<%=ctxPath%>/servlet/product-detail?isbn='+row.isbn+'">查看</a>丨<a href="<%=ctxPath%>/servlet/product-edit?isbn='+row.isbn+'">编辑</a>';
	    		}
    	    }
    	  ]
	 */
